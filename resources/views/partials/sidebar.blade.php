...
<div class="list-group">
    ...
    <a href="{!! url('collection/custom-filter') !!}" class="list-group-item {!! Request::is('collection/custom-filter') ? 'active' : '' !!}">Custom Filter</a>
    <a href="{!! url('collection/carbon') !!}" class="list-group-item {!! Request::is('collection/carbon') ? 'active' : '' !!}">DateTime/Carbon Objects</a>
</div>
